...
import {
  ...
  softwareProjects,
  testData,
} from "../../data/PdfChatbot";

export const PdfChatbot = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Navbar title="PDF Chatbot" />

      <main className="container mx-auto px-30 py-40">
        {/* HEADER SECTION */}
          ...
          <div className="md:col-span-2">
            <section className="mb-12" id="about">
              ...
              <p className="text-muted-foreground leading-relaxed text-start">
                Een AI‑gedreven chatbot die PDF‑documenten verwerkt en
                gebruikersvragen beantwoordt met behulp van een Large Language
                Model (LLM) met ingebouwde NLP‑mogelijkheden.
              </p>
            </section>
        ...
        <section className="mt-20">
          ...
          <p className="text-muted-foreground leading-relaxed text-start mb-6 font-small italic">
            ...
            ontwerp van het project. In die document staat beschreven wat de
            wensen en eisen van de klant zijn, hoe het project was gepland en
            ontworpen.
          </p>
                      ...
                      {project.solutions.map((sol, i) => (
                        <li key={i}>
                          ...
                          {sol.href ? (
                            <a
                              href={sol.href}
                              target={sol.isExternal ? "_blank" : "_self"}
                              rel={
                                sol.isExternal
                                  ? "noopener noreferrer"
                                  : undefined
