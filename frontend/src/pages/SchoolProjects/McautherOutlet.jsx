    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="bg-gradient-to-r from-primary/10 to-primary/5 py-8 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold">McAuther Outlet</h1>
        </div>
      </div>
          ...
          <div className="md:col-span-2">
            ...
            <section className="mb-12">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Een e-commerce platform voor McAuther Designer Outlet. Het
                systeem biedt productcatalogus, winkelwagen en
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-lg bg-card border border-border">
                  <h3 className="font-semibold text-foreground">Odoo</h3>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2 text-sm">
                  <p>
                    ...
                    <span className="ml-2 font-medium">2023-10</span>
                  </p>
                  <p>
                    <span className="text-muted-foreground">Eind:</span>
                    <span className="ml-2 font-medium">2023-12</span>
                  </p>
                </div>
              </div>
