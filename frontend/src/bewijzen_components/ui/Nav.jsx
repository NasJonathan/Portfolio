...
export const Navbar = () => {
  ...
  const [currentSection, setCurrentSection] = useState("NasPortfolio");
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            setCurrentSection(entry.target.textContent || "NasPortfolio");
          }
        });
      },
      {
  ...
  return (
    ...
    >
      <div className="container mx-auto flex items-center justify-between">
        {/* Left: Brand Name - Shows current section */}
        <a className="text-3xl font-bold ">{currentSection}</a>
